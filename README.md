...
- Die "Verhandlungs-Argumente" (Objekt-Detailseite) sind rein aus den eigenen Modelldaten abgeleitete Fakten (Gewerke-Zustand, Instandhaltungs-Unterdeckung, Break-even-Kaufpreis) — keine Rechtsberatung. Der Kaufpreisfaktor-Vergleich nutzt die selbst editierbaren Referenzwerte auf `/immobilien/referenzdaten` (Startwerte je Objekttyp/Lagetyp, keine echten Marktdaten).
