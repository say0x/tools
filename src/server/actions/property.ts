...
const propertySchema = z.object({
  ...
  notarGrundbuchProzent: z.coerce.number().min(0),
  notarGrundbuchOverride: z.boolean(),
...
export async function dupliziereObjekt(id: string) {
  ...
  const created = await prisma.property.create({
    data: {
      ...
      notarGrundbuchProzent: original.notarGrundbuchProzent,
      notarGrundbuchOverride: original.notarGrundbuchOverride,
